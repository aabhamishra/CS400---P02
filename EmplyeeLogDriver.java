			...
			if (input.equals("A") || input.equals("a")) {
				...
				while (!quit) {
					...
					if (secondaryInput.equals("L") || secondaryInput.equals("l")) {
						// Stores the name of the employee in the left most part of the tree, then
						// prints the name out
						...
						// Stores the name of the employee in the right most part of the tree, then
						// prints the name out
						String lastEmployee = log.getMax();
						if (lastEmployee != null)
							System.out
									.println("This is the employee that has stayed here the shortest: " + log.getMax());
						...
						// Stores the time the user inputted into a string variable, then parse it into
						// an int variable
						String secondaryTime = scnr.next();
						int timeInt = Employee.inputToInt(secondaryTime);
						// If an employee is found with the time the user inputted, it prints out the
						// String. If no employee
